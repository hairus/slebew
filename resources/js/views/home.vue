 ...
 */
export default {
    components: { Buttons, Layout, Profile, Stat, Transaction, Earning, Emailsent, TableQ, GDialog },
    data() {
        return {
            title: "Dashboard",
            loading: false,
    ...
    <Layout>
        ...
        <BRow>
            ...
            <BCol xl="12">
                ...
                <button class="btn btn-success my-3" v-if="tokens.ip" @click="singkron"><i class="fa fa-radiation"></i>
                    Singkron Dapodik</button>
                <div class="col-12">
                    <div class="row">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr v-if="tokens.ip">
                                            ...
                                            <td>{{ tokens.token }}</td>
                                            <td>
                                                <button class="btn btn-sm btn-danger" @click="delToken(tokens.id)"><i
