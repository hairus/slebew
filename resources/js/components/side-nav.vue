...
import { menuItems, fetchMenuItems } from "./menu";
/**
 * Side-nav component
 */
export default {
    ...
    created() {
        fetchMenuItems().then(() => {
            this.menuItems = menuItems.value;
        });
    },
    watch: {
        menuItems
    ...
    <div id="sidebar-menu">
        ...
        <ul id="side-menu" class="metismenu list-unstyled">
            <template v-for="item in menuItems" :key="item.id">
                <!-- role admin -->
                <div v-if="user.roles && user.roles[0]['role'] === 'admin'">
                    <div v-if="item.role === user.roles[0]['role']">
                        <li
                            class="menu-title"
                            v-if="item.isTitle"
                            :key="item.id"
                ...
                <!-- role guru -->
                <div v-if="user.roles && user.roles[0]['role'] === 'guru'">
                    <div v-if="item.role === user.roles[0]['role']">
                        <li
                            class="menu-title"
                            v-if="item.isTitle"
