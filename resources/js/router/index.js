...
const routes = [{
    ...
    },
    {
        ...
        component: () =>
            import ('../views/dashboard/crypto.vue'),
    },
    {
        path: '/dashboard/blog',
        meta: { title: 'Blog', authRequired: true, },
        component: () =>
            import ('../views/dashboard/blog.vue'),
    },
    {
        path: '/dashboard/job',
        meta: { authRequired: true, title: 'Job' },
        component: () =>
            import ('../views/dashboard/jobs/index.vue'),
    },
    {
        path: '/calendar',
    ...
    },
    {
        ...
        meta: { title: 'Register' },
        component: () =>
            import ('../views/sample-pages/register-sample.vue')
    },
    {
    ...
    },
    {
        ...
        component: () =>
            import ('../views/sample-pages/lockscreen.vue')
    },
    {
        path: '/auth/lock-screen-2',
        meta: { authRequired: true, title: 'Lock Screen' },
        component: () =>
            import ('../views/sample-pages/lockscreen-2.vue')
    },
    {
    ...
    },
    {
        ...
        component: () =>
            import ('../views/utility/starter.vue')
    },
    {
        path: '/pages/maintenance',
        meta: { authRequired: true, title: 'Maintenance' },
        component: () =>
            import ('../views/utility/maintenance.vue')
    },
    {
        path: '/pages/coming-soon',
        meta: { authRequired: true, title: 'Comming Soon' },
        component: () =>
            import ('../views/utility/coming-soon.vue')
    },
    {
        path: '/pages/timeline',
        meta: { authRequired: true, title: 'Timeline' },
        component: () =>
            import ('../views/utility/timeline.vue')
    },
    {
        path: '/pages/faqs',
        meta: { authRequired: true, title: 'FaQs' },
        component: () =>
            import ('../views/utility/faqs.vue')
    },
    {
        path: '/pages/pricing',
        meta: { authRequired: true, title: 'Pricing' },
        component: () =>
            import ('../views/utility/pricing.vue')
    },
    {
        path: '/pages/404',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/utility/500.vue')
    },
    {
        path: '/ui/alerts',
        meta: { authRequired: true, title: 'Alerts' },
        component: () =>
            import ('../views/ui/alerts.vue')
    },
    {
        path: '/ui/buttons',
        meta: { authRequired: true, title: 'Buttons' },
        component: () =>
            import ('../views/ui/buttons.vue')
    },
    {
        path: '/ui/cards',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/ui/utilities.vue')
    },
    {
        path: '/ui/video',
        meta: { authRequired: true, title: 'Video' },
        component: () =>
            import ('../views/ui/video.vue')
    },
    {
        path: '/form/elements',
